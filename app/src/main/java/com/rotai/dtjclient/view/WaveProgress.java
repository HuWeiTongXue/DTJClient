...
import com.rotai.dtjclient.BuildConfig;
import com.rotai.dtjclient.R;
import com.rotai.dtjclient.base.Constant;
import com.rotai.dtjclient.util.MiscUtil;
...
public class WaveProgress extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mMaxValue = typedArray.getInt(R.styleable.WaveProgress_maxValue, Constant.DEFAULT_MAX_VALUE);
        mValue = typedArray.getInt(R.styleable.WaveProgress_value, Constant.DEFAULT_VALUE);
