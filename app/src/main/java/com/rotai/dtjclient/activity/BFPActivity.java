            ...
            if (data.getInt("network") == 1) {
                ...
                if (wakeup ==1) {
                    if (mDialog != null && mDialog.isShowing()) {
                        ...
                        file = ctx.getResources().openRawResourceFd(R.raw.bmi);
                        ...
                        mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                            ...
                            public void onCompletion(MediaPlayer mp) {
                                playing = false;
//                                ctx.startActivity(new Intent(  BFPActivity.this, FaceActivity.class));
                                mediaPlayer.release();
                            }
                        });
                ...
                startActivity(new Intent(BFPActivity.this, SplashActivity.class));
            }
        }
    }
    ...
    void showDialog() {
        ...
        //dialog
        builder = new AlertDialog.Builder(BFPActivity.this);
        View view = View.inflate(BFPActivity.this, R.layout.dialog_main_notice, null);
